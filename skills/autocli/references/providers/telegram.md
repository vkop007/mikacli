...
- Provider: `telegram`
- Category: `social`
- Command prefix: `autocli social telegram`
- Aliases: none
- Auth: `session`
- Stability: `partial`
- Discovery: `supported`
...
Usage:
```bash
autocli social telegram [command]
```
...
Usage:
```bash
autocli social telegram login [options]
```
...
Usage:
```bash
autocli social telegram status [options]
```
...
Usage:
```bash
autocli social telegram me [options]
```
...
Usage:
```bash
autocli social telegram chats [options]
```
...
Usage:
```bash
autocli social telegram history [options] <target>
```
...
Usage:
```bash
autocli social telegram send [options] <target> <text...>
```
...
Usage:
```bash
autocli social telegram capabilities [options]
```
