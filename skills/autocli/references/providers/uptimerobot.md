...
Usage:
```bash
autocli devops uptimerobot alert-contacts [options]
```
...
Usage:
```bash
autocli devops uptimerobot all-alert-contacts [options]
```
...
Usage:
```bash
autocli devops uptimerobot delete-monitor [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot reset-monitor [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot incident-comments [options] <incident-id>
```
...
Usage:
```bash
autocli devops uptimerobot create-incident-comment [options] <incident-id>
```
...
Usage:
```bash
autocli devops uptimerobot update-incident-comment [options] <incident-id> <comment-id>
```
...
Usage:
```bash
autocli devops uptimerobot delete-incident-comment [options] <incident-id> <comment-id>
```
...
Usage:
```bash
autocli devops uptimerobot incident-activity-log [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot incident-alerts [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot create-integration [options]
```
...
Usage:
```bash
autocli devops uptimerobot update-integration [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot delete-integration [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot monitor-groups [options]
```
...
Usage:
```bash
autocli devops uptimerobot monitor-group [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot create-monitor-group [options]
```
...
Usage:
```bash
autocli devops uptimerobot update-monitor-group [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot delete-monitor-group [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot maintenance-windows [options]
```
...
Usage:
```bash
autocli devops uptimerobot maintenance-window [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot create-maintenance-window [options]
```
...
Usage:
```bash
autocli devops uptimerobot update-maintenance-window [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot delete-maintenance-window [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot psps [options]
```
...
Usage:
```bash
autocli devops uptimerobot psp [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot create-psp [options]
```
...
Usage:
```bash
autocli devops uptimerobot update-psp [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot delete-psp [options] <id>
```
...
Usage:
```bash
autocli devops uptimerobot announcements [options] <psp-id>
```
...
Usage:
```bash
autocli devops uptimerobot announcement [options] <psp-id> <id>
```
...
Usage:
```bash
autocli devops uptimerobot create-announcement [options] <psp-id>
```
...
Usage:
```bash
autocli devops uptimerobot update-announcement [options] <psp-id> <id>
```
...
Usage:
```bash
autocli devops uptimerobot pin-announcement [options] <psp-id> <id>
```
...
Usage:
```bash
autocli devops uptimerobot unpin-announcement [options] <psp-id> <id>
```
...
Usage:
```bash
autocli devops uptimerobot tags [options]
```
...
Usage:
```bash
autocli devops uptimerobot delete-tag [options] <id>
```
