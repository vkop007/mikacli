...
- Provider: `flipkart`
- Category: `shopping`
- Command prefix: `autocli shopping flipkart`
- Aliases: none
- Auth: `cookies`
- Stability: `stable`
- Discovery: `supported`
...
Usage:
```bash
autocli shopping flipkart [command]
```
...
Usage:
```bash
autocli shopping flipkart status [options]
```
...
Usage:
```bash
autocli shopping flipkart search [options] <query>
```
...
Usage:
```bash
autocli shopping flipkart product [options] <target>
```
...
Usage:
```bash
autocli shopping flipkart orders [options]
```
...
Usage:
```bash
autocli shopping flipkart account [options]
```
...
Usage:
```bash
autocli shopping flipkart wishlist [options]
```
...
Usage:
```bash
autocli shopping flipkart cart [options]
```
...
Usage:
```bash
autocli shopping flipkart add-to-cart [options] <target>
```
...
Usage:
```bash
autocli shopping flipkart remove-from-cart [options] <target>
```
...
Usage:
```bash
autocli shopping flipkart update-cart [options] <target>
```
...
Usage:
```bash
autocli shopping flipkart order [options] <target>
```
...
Usage:
```bash
autocli shopping flipkart capabilities [options]
```
