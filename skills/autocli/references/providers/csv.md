...
- Provider: `csv`
- Category: `data`
- Command prefix: `autocli data csv`
- Aliases: none
- Auth: `none`
- Stability: `stable`
- Discovery: `supported`
...
- `autocli data csv capabilities --json`

## Default Command

Usage:
```bash
autocli data csv [command]
```
...
Usage:
```bash
autocli data csv info [options] <source>
```
...
Usage:
```bash
autocli data csv to-json [options] <source>
```
...
Usage:
```bash
autocli data csv filter [options] <source>
```
...
Usage:
```bash
autocli data csv capabilities [options]
```
