...
- Provider: `githubbot`
- Category: `bot`
- Command prefix: `autocli bot githubbot`
- Aliases: `ghbot`
- Auth: `apiKey`
- Stability: `stable`
- Discovery: `supported`
...
- `autocli bot githubbot user openai`
- `autocli bot githubbot capabilities --json`

## Default Command

Usage:
```bash
autocli bot githubbot [command]
```
...
Usage:
```bash
autocli bot githubbot login [options]
```
...
Usage:
```bash
autocli bot githubbot me [options]
```
...
Usage:
```bash
autocli bot githubbot user [options] <login>
```
...
Usage:
```bash
autocli bot githubbot repos [options] [owner]
```
...
Usage:
```bash
autocli bot githubbot repo [options] <target>
```
...
Usage:
```bash
autocli bot githubbot search-repos [options] <query>
```
...
Usage:
```bash
autocli bot githubbot starred [options] [owner]
```
...
Usage:
```bash
autocli bot githubbot branches [options] <repo>
```
...
Usage:
```bash
autocli bot githubbot branch [options] <repo> <branch>
```
...
Usage:
```bash
autocli bot githubbot issues [options] <repo>
```
...
Usage:
```bash
autocli bot githubbot issue [options] <repo> <number>
```
...
Usage:
```bash
autocli bot githubbot pulls [options] <repo>
```
...
Usage:
```bash
autocli bot githubbot pull [options] <repo> <number>
```
...
Usage:
```bash
autocli bot githubbot releases [options] <repo>
```
...
Usage:
```bash
autocli bot githubbot readme [options] <repo>
```
...
Usage:
```bash
autocli bot githubbot create-issue [options] <repo>
```
...
Usage:
```bash
autocli bot githubbot comment [options] <repo> <number>
```
...
Usage:
```bash
autocli bot githubbot create-repo [options] <name>
```
...
Usage:
```bash
autocli bot githubbot fork [options] <repo>
```
...
Usage:
```bash
autocli bot githubbot star [options] <repo>
```
...
Usage:
```bash
autocli bot githubbot unstar [options] <repo>
```
...
Usage:
```bash
autocli bot githubbot capabilities [options]
```
