...
- Provider: `docs`
- Category: `google`
- Command prefix: `autocli google docs`
- Aliases: none
- Auth: `oauth2`
- Stability: `stable`
- Discovery: `supported`
...
- `autocli google docs capabilities --json`

## Default Command

Usage:
```bash
autocli google docs [command]
```
...
Usage:
```bash
autocli google docs auth-url [options]
```
...
Usage:
```bash
autocli google docs login [options]
```
...
Usage:
```bash
autocli google docs status [options]
```
...
Usage:
```bash
autocli google docs me [options]
```
...
Usage:
```bash
autocli google docs documents [options]
```
...
Usage:
```bash
autocli google docs document [options] <document-id>
```
...
Usage:
```bash
autocli google docs content [options] <document-id>
```
...
Usage:
```bash
autocli google docs create [options] <title>
```
...
Usage:
```bash
autocli google docs append-text [options] <document-id> <text...>
```
...
Usage:
```bash
autocli google docs replace-text [options] <document-id>
```
...
Usage:
```bash
autocli google docs capabilities [options]
```
