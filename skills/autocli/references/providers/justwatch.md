...
- Provider: `justwatch`
- Category: `movie`
- Command prefix: `autocli movie justwatch`
- Aliases: none
- Auth: `none`
- Stability: `stable`
- Discovery: `supported`
...
- `autocli movie justwatch title https://www.justwatch.com/us/movie/inception`
- `autocli movie justwatch availability /us/movie/inception`
- `autocli movie justwatch trending --country US --type movie`
- `autocli movie justwatch capabilities --json`

## Default Command

Usage:
```bash
autocli movie justwatch [command]
```
...
Usage:
```bash
autocli movie justwatch title [options] <target>
```
...
Usage:
```bash
autocli movie justwatch availability [options] <target>
```
...
Usage:
```bash
autocli movie justwatch trending [options]
```
...
Usage:
```bash
autocli movie justwatch new [options]
```
...
Usage:
```bash
autocli movie justwatch capabilities [options]
```
