...
- Provider: `sheets`
- Category: `google`
- Command prefix: `autocli google sheets`
- Aliases: none
- Auth: `oauth2`
- Stability: `stable`
- Discovery: `supported`
...
- `autocli google sheets capabilities --json`

## Default Command

Usage:
```bash
autocli google sheets [command]
```
...
Usage:
```bash
autocli google sheets auth-url [options]
```
...
Usage:
```bash
autocli google sheets login [options]
```
...
Usage:
```bash
autocli google sheets status [options]
```
...
Usage:
```bash
autocli google sheets me [options]
```
...
Usage:
```bash
autocli google sheets create [options] <title>
```
...
Usage:
```bash
autocli google sheets spreadsheet [options] <spreadsheet-id>
```
...
Usage:
```bash
autocli google sheets values [options] <spreadsheet-id> <range>
```
...
Usage:
```bash
autocli google sheets append [options] <spreadsheet-id> <range>
```
...
Usage:
```bash
autocli google sheets update [options] <spreadsheet-id> <range>
```
...
Usage:
```bash
autocli google sheets clear [options] <spreadsheet-id> <range>
```
...
Usage:
```bash
autocli google sheets capabilities [options]
```
