...
- Category: `bot`
- Command prefix: `autocli bot telegrambot`
- Aliases: `telegram`
- Auth: `botToken`
- Stability: `stable`
- Discovery: `supported`
...
- `autocli bot telegrambot capabilities --json`

## Default Command

Usage:
```bash
autocli bot telegrambot [command]
```
...
Usage:
```bash
autocli bot telegrambot login [options]
```
...
Usage:
```bash
autocli bot telegrambot me [options]
```
...
Usage:
```bash
autocli bot telegrambot getchat [options] <chatId>
```
...
Usage:
```bash
autocli bot telegrambot chats [options]
```
...
Usage:
```bash
autocli bot telegrambot updates [options]
```
...
Usage:
```bash
autocli bot telegrambot send [options] <chatId> <text...>
```
...
Usage:
```bash
autocli bot telegrambot send-photo [options] <chatId> <photo>
```
...
Usage:
```bash
autocli bot telegrambot send-document [options] <chatId> <document>
```
...
Usage:
```bash
autocli bot telegrambot send-video [options] <chatId> <video>
```
...
Usage:
```bash
autocli bot telegrambot send-audio [options] <chatId> <audio>
```
...
Usage:
```bash
autocli bot telegrambot send-voice [options] <chatId> <voice>
```
...
Usage:
```bash
autocli bot telegrambot edit [options] <chatId> <messageId> <text...>
```
...
Usage:
```bash
autocli bot telegrambot delete [options] <chatId> <messageId>
```
...
Usage:
```bash
autocli bot telegrambot capabilities [options]
```
