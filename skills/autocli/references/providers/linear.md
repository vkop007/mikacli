...
- `autocli developer linear login`
...
Save the Linear web session for future CLI use. With no auth flags, AutoCLI opens browser login by default
...
Usage:
```bash
autocli developer linear status [options]
```
