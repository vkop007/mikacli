...
- Provider: `forms`
- Category: `google`
- Command prefix: `autocli google forms`
- Aliases: none
- Auth: `oauth2`
- Stability: `stable`
- Discovery: `supported`
...
- `autocli google forms capabilities --json`

## Default Command

Usage:
```bash
autocli google forms [command]
```
...
Usage:
```bash
autocli google forms auth-url [options]
```
...
Usage:
```bash
autocli google forms login [options]
```
...
Usage:
```bash
autocli google forms status [options]
```
...
Usage:
```bash
autocli google forms me [options]
```
...
Usage:
```bash
autocli google forms forms [options]
```
...
Usage:
```bash
autocli google forms form [options] <form-id>
```
...
Usage:
```bash
autocli google forms responses [options] <form-id>
```
...
Usage:
```bash
autocli google forms response [options] <form-id> <response-id>
```
...
Usage:
```bash
autocli google forms create [options] <title>
```
...
Usage:
```bash
autocli google forms update-info [options] <form-id>
```
...
Usage:
```bash
autocli google forms add-text-question [options] <form-id>
```
...
Usage:
```bash
autocli google forms add-choice-question [options] <form-id>
```
...
Usage:
```bash
autocli google forms delete-item [options] <form-id>
```
...
Usage:
```bash
autocli google forms publish [options] <form-id>
```
...
Usage:
```bash
autocli google forms delete [options] <form-id>
```
...
Usage:
```bash
autocli google forms capabilities [options]
```
