...
- Provider: `xml`
- Category: `data`
- Command prefix: `mikacli data xml`
- Aliases: none
- Auth: `none`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli data xml capabilities --json`

## Default Command

Usage:
```bash
mikacli data xml [command]
```
...
Usage:
```bash
mikacli data xml format [options] <source>
```
...
Usage:
```bash
mikacli data xml to-json [options] <source>
```
...
Usage:
```bash
mikacli data xml capabilities [options]
```
