...
- Provider: `bluesky`
- Category: `social`
- Command prefix: `mikacli social bluesky`
- Aliases: none
- Auth: `none`, `session`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli social bluesky capabilities --json`

## Default Command

Usage:
```bash
mikacli social bluesky [command]
```
...
Usage:
```bash
mikacli social bluesky login [options]
```
...
Usage:
```bash
mikacli social bluesky status [options]
```
...
Usage:
```bash
mikacli social bluesky me [options]
```
...
Usage:
```bash
mikacli social bluesky search [options] <query>
```
...
Usage:
```bash
mikacli social bluesky profile [options] <target>
```
...
Usage:
```bash
mikacli social bluesky posts [options] <target>
```
...
Usage:
```bash
mikacli social bluesky thread [options] <target>
```
...
Usage:
```bash
mikacli social bluesky post [options] <text...>
```
...
Usage:
```bash
mikacli social bluesky comment [options] <target> <text...>
```
...
Usage:
```bash
mikacli social bluesky like [options] <target>
```
...
Usage:
```bash
mikacli social bluesky capabilities [options]
```
