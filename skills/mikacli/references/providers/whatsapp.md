...
- Provider: `whatsapp`
- Category: `social`
- Command prefix: `mikacli social whatsapp`
- Aliases: none
- Auth: `session`
- Stability: `partial`
- Discovery: `supported`
...
- `mikacli social whatsapp capabilities --json`

## Default Command

Usage:
```bash
mikacli social whatsapp [command]
```
...
Usage:
```bash
mikacli social whatsapp login [options]
```
...
Usage:
```bash
mikacli social whatsapp status [options]
```
...
Usage:
```bash
mikacli social whatsapp me [options]
```
...
Usage:
```bash
mikacli social whatsapp chats [options]
```
...
Usage:
```bash
mikacli social whatsapp history [options] <target>
```
...
Usage:
```bash
mikacli social whatsapp send [options] <target> <text...>
```
...
Usage:
```bash
mikacli social whatsapp capabilities [options]
```
