...
- Provider: `image`
- Category: `editor`
- Command prefix: `mikacli editor image`
- Aliases: none
- Auth: `none`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli editor image info ./photo.png`
- `mikacli editor image resize ./photo.png --width 1200`
- `mikacli editor image crop ./photo.png --width 1080 --height 1080`
- `mikacli editor image capabilities --json`

## Default Command

Usage:
```bash
mikacli editor image [command]
```
...
Usage:
```bash
mikacli editor image info [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image resize [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image crop [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image convert [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image rotate [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image upscale [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image grayscale [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image blur [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image sharpen [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image thumbnail [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image strip-metadata [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image background-remove [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image watermark [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image exif [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image palette [options] <inputPath>
```
...
Usage:
```bash
mikacli editor image collage [options] <inputPaths...>
```
...
Usage:
```bash
mikacli editor image capabilities [options]
```
