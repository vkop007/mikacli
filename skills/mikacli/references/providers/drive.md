...
- Provider: `drive`
- Category: `google`
- Command prefix: `mikacli google drive`
- Aliases: none
- Auth: `oauth2`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli google drive capabilities --json`

## Default Command

Usage:
```bash
mikacli google drive [command]
```
...
Usage:
```bash
mikacli google drive auth-url [options]
```
...
Usage:
```bash
mikacli google drive login [options]
```
...
Usage:
```bash
mikacli google drive status [options]
```
...
Usage:
```bash
mikacli google drive me [options]
```
...
Usage:
```bash
mikacli google drive files [options]
```
...
Usage:
```bash
mikacli google drive file [options] <id>
```
...
Usage:
```bash
mikacli google drive create-folder [options] <name>
```
...
Usage:
```bash
mikacli google drive upload [options] <path>
```
...
Usage:
```bash
mikacli google drive download [options] <id>
```
...
Usage:
```bash
mikacli google drive delete [options] <id>
```
...
Usage:
```bash
mikacli google drive capabilities [options]
```
