...
- Provider: `osrm`
- Category: `maps`
- Command prefix: `mikacli maps osrm`
- Aliases: none
- Auth: `none`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli maps osrm route "19.0760,72.8777" "28.6139,77.2090"`
- `mikacli maps osrm route "19.0760,72.8777" "19.2183,72.9781" --profile driving`
- `mikacli maps osrm table "19.0760,72.8777" "28.6139,77.2090" "19.2183,72.9781"`
- `mikacli maps osrm capabilities --json`

## Default Command

Usage:
```bash
mikacli maps osrm [command]
```
...
Usage:
```bash
mikacli maps osrm route [options] <from> <to>
```
...
Usage:
```bash
mikacli maps osrm table [options] <coordinates...>
```
...
Usage:
```bash
mikacli maps osrm nearest [options] <coordinate>
```
...
Usage:
```bash
mikacli maps osrm trip [options] <coordinates...>
```
...
Usage:
```bash
mikacli maps osrm match [options] <coordinates...>
```
...
Usage:
```bash
mikacli maps osrm capabilities [options]
```
