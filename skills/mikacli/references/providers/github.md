...
- Provider: `github`
- Category: `developer`
- Command prefix: `mikacli developer github`
- Aliases: `gh`
- Auth: `cookies`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli developer github login`
...
Usage:
```bash
mikacli developer github [command]
```
...
Usage:
```bash
mikacli developer github login [options]
```

Save the GitHub web session for future CLI use. With no auth flags, MikaCLI opens browser login by default
...
Usage:
```bash
mikacli developer github status [options]
```
...
Usage:
```bash
mikacli developer github me [options]
```
...
Usage:
```bash
mikacli developer github user [options] <login>
```
...
Usage:
```bash
mikacli developer github repos [options] [owner]
```
...
Usage:
```bash
mikacli developer github repo [options] <target>
```
...
Usage:
```bash
mikacli developer github search-repos [options] <query>
```
...
Usage:
```bash
mikacli developer github starred [options] [owner]
```
...
Usage:
```bash
mikacli developer github branches [options] <repo>
```
...
Usage:
```bash
mikacli developer github branch [options] <repo> <branch>
```
...
Usage:
```bash
mikacli developer github issues [options] <repo>
```
...
Usage:
```bash
mikacli developer github issue [options] <repo> <number>
```
...
Usage:
```bash
mikacli developer github pulls [options] <repo>
```
...
Usage:
```bash
mikacli developer github pull [options] <repo> <number>
```
...
Usage:
```bash
mikacli developer github releases [options] <repo>
```
...
Usage:
```bash
mikacli developer github readme [options] <repo>
```
...
Usage:
```bash
mikacli developer github create-issue [options] <repo>
```
...
Usage:
```bash
mikacli developer github comment [options] <repo> <number>
```
...
Usage:
```bash
mikacli developer github create-repo [options] <name>
```
...
Usage:
```bash
mikacli developer github fork [options] <repo>
```
...
Usage:
```bash
mikacli developer github star [options] <repo>
```
...
Usage:
```bash
mikacli developer github unstar [options] <repo>
```
...
Usage:
```bash
mikacli developer github capabilities [options]
```
