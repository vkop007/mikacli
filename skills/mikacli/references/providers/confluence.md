...
- Provider: `confluence`
- Category: `developer`
- Command prefix: `mikacli developer confluence`
- Aliases: none
- Auth: `cookies`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli developer confluence login --site https://your-workspace.atlassian.net/wiki`
- `mikacli developer confluence login --cookies ./confluence.cookies.json --site https://your-workspace.atlassian.net/wiki`
- `mikacli developer confluence me`
- `mikacli developer confluence capabilities --json`

## Default Command

Usage:
```bash
mikacli developer confluence [command]
```
...
Usage:
```bash
mikacli developer confluence login [options]
```

Save the Confluence web session for future CLI use. With no auth flags, MikaCLI opens browser login by default
...
Usage:
```bash
mikacli developer confluence status [options]
```
...
Usage:
```bash
mikacli developer confluence me [options]
```
...
Usage:
```bash
mikacli developer confluence spaces [options] [query]
```
...
Usage:
```bash
mikacli developer confluence search [options] <query>
```
...
Usage:
```bash
mikacli developer confluence page [options] <target>
```
...
Usage:
```bash
mikacli developer confluence children [options] <target>
```
...
Usage:
```bash
mikacli developer confluence create-page [options]
```
...
Usage:
```bash
mikacli developer confluence update-page [options] <target>
```
...
Usage:
```bash
mikacli developer confluence comment [options] <target>
```
...
Usage:
```bash
mikacli developer confluence capabilities [options]
```
