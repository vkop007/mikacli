...
- Provider: `json`
- Category: `data`
- Command prefix: `mikacli data json`
- Aliases: none
- Auth: `none`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli data json capabilities --json`

## Default Command

Usage:
```bash
mikacli data json [command]
```
...
Usage:
```bash
mikacli data json format [options] <source>
```
...
Usage:
```bash
mikacli data json query [options] <source> <path>
```
...
Usage:
```bash
mikacli data json merge [options] <sources...>
```
...
Usage:
```bash
mikacli data json capabilities [options]
```
