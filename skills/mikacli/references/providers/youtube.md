...
- Provider: `youtube`
- Category: `social`
- Command prefix: `mikacli social youtube`
- Aliases: `yt`
- Auth: `cookies`
- Stability: `partial`
- Discovery: `supported`
...
Interact with YouTube using an imported browser session for public lookup, engagement, and Studio uploads. Use `mikacli tools download` for cross-site media downloads.
...
- `mikacli social youtube capabilities --json`

## Default Command

Usage:
```bash
mikacli social youtube [command]
```
...
Usage:
```bash
mikacli social youtube login [options]
```

Save the YouTube session for future headless use. With no auth flags, MikaCLI opens browser login by default
...
Usage:
```bash
mikacli social youtube status [options]
```
...
Usage:
```bash
mikacli social youtube upload [options] <mediaPath>
```
...
Usage:
```bash
mikacli social youtube post [options] <text>
```
...
Usage:
```bash
mikacli social youtube search [options] <query>
```
...
Usage:
```bash
mikacli social youtube videoid [options] <target>
```
...
Usage:
```bash
mikacli social youtube channelid [options] <target>
```
...
Usage:
```bash
mikacli social youtube playlistid [options] <target>
```
...
Usage:
```bash
mikacli social youtube related [options] <target>
```
...
Usage:
```bash
mikacli social youtube captions [options] <target>
```
...
Usage:
```bash
mikacli social youtube like [options] <target>
```
...
Usage:
```bash
mikacli social youtube dislike [options] <target>
```
...
Usage:
```bash
mikacli social youtube unlike [options] <target>
```
...
Usage:
```bash
mikacli social youtube comment [options] <target> <text>
```
...
Usage:
```bash
mikacli social youtube delete [options] <target>
```
...
Usage:
```bash
mikacli social youtube subscribe [options] <target>
```
...
Usage:
```bash
mikacli social youtube unsubscribe [options] <target>
```
...
Usage:
```bash
mikacli social youtube capabilities [options]
```
