...
- Provider: `gitlab`
- Category: `developer`
- Command prefix: `mikacli developer gitlab`
- Aliases: `gl`
- Auth: `cookies`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli developer gitlab login`
- `mikacli developer gitlab login --cookies ./gitlab.cookies.json`
- `mikacli developer gitlab login --cookies ./gitlab.cookies.json --account work`
- `mikacli developer gitlab capabilities --json`

## Default Command

Usage:
```bash
mikacli developer gitlab [command]
```
...
Usage:
```bash
mikacli developer gitlab login [options]
```

Save the GitLab web session for future CLI use. With no auth flags, MikaCLI opens browser login by default
...
Usage:
```bash
mikacli developer gitlab status [options]
```
...
Usage:
```bash
mikacli developer gitlab me [options]
```
...
Usage:
```bash
mikacli developer gitlab projects [options] [query]
```
...
Usage:
```bash
mikacli developer gitlab project [options] <target>
```
...
Usage:
```bash
mikacli developer gitlab search-projects [options] <query>
```
...
Usage:
```bash
mikacli developer gitlab issues [options] <project>
```
...
Usage:
```bash
mikacli developer gitlab issue [options] <project> <iid>
```
...
Usage:
```bash
mikacli developer gitlab create-issue [options] <project>
```
...
Usage:
```bash
mikacli developer gitlab merge-requests [options] <project>
```
...
Usage:
```bash
mikacli developer gitlab merge-request [options] <project> <iid>
```
...
Usage:
```bash
mikacli developer gitlab capabilities [options]
```
