...
- Provider: `calendar`
- Category: `google`
- Command prefix: `mikacli google calendar`
- Aliases: none
- Auth: `oauth2`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli google calendar capabilities --json`

## Default Command

Usage:
```bash
mikacli google calendar [command]
```
...
Usage:
```bash
mikacli google calendar auth-url [options]
```
...
Usage:
```bash
mikacli google calendar login [options]
```
...
Usage:
```bash
mikacli google calendar status [options]
```
...
Usage:
```bash
mikacli google calendar me [options]
```
...
Usage:
```bash
mikacli google calendar calendars [options]
```
...
Usage:
```bash
mikacli google calendar calendar [options] <calendar-id>
```
...
Usage:
```bash
mikacli google calendar events [options]
```
...
Usage:
```bash
mikacli google calendar today [options]
```
...
Usage:
```bash
mikacli google calendar event [options] <event-id>
```
...
Usage:
```bash
mikacli google calendar create-event [options]
```
...
Usage:
```bash
mikacli google calendar update-event [options] <event-id>
```
...
Usage:
```bash
mikacli google calendar delete-event [options] <event-id>
```
...
Usage:
```bash
mikacli google calendar capabilities [options]
```
