...
- Provider: `perplexity`
- Category: `llm`
- Command prefix: `mikacli llm perplexity`
- Aliases: none
- Auth: `cookies`
- Stability: `partial`
- Discovery: `supported`
...
- `mikacli llm perplexity login`
- `mikacli llm perplexity login --cookies ./perplexity.cookies.json`
- `mikacli llm perplexity text "Summarize the latest AI browser trends"`
- `mikacli llm perplexity capabilities --json`

## Default Command

Usage:
```bash
mikacli llm perplexity [command]
```
...
Usage:
```bash
mikacli llm perplexity login [options]
```

Save the Perplexity session for future CLI use. With no auth flags, MikaCLI opens browser login by default
...
Usage:
```bash
mikacli llm perplexity status [options]
```
...
Usage:
```bash
mikacli llm perplexity text [options] <prompt...>
```
...
Usage:
```bash
mikacli llm perplexity image [options] <mediaPath>
```
...
Usage:
```bash
mikacli llm perplexity video [options] <prompt...>
```
...
Usage:
```bash
mikacli llm perplexity capabilities [options]
```
