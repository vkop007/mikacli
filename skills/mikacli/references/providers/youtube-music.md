...
- Category: `music`
- Command prefix: `mikacli music youtube-music`
- Aliases: `ytmusic`
- Auth: `cookies`
- Stability: `partial`
- Discovery: `supported`
...
- `mikacli music youtube-music login`
- `mikacli music youtube-music login --cookies ./youtube.cookies.json`
- `mikacli music youtube-music play HZbsLxL7GeM`
- `mikacli music youtube-music capabilities --json`

## Default Command

Usage:
```bash
mikacli music youtube-music [command]
```
...
Usage:
```bash
mikacli music youtube-music login [options]
```

Save the YouTube Music session for future headless use. With no auth flags, MikaCLI opens browser login by default
...
Usage:
```bash
mikacli music youtube-music status [options]
```
...
Usage:
```bash
mikacli music youtube-music play [options] [target]
```
...
Usage:
```bash
mikacli music youtube-music pause [options]
```
...
Usage:
```bash
mikacli music youtube-music stop [options]
```
...
Usage:
```bash
mikacli music youtube-music next [options]
```
...
Usage:
```bash
mikacli music youtube-music previous [options]
```
...
Usage:
```bash
mikacli music youtube-music queue [options]
```
...
Usage:
```bash
mikacli music youtube-music queueadd [options] <target>
```
...
Usage:
```bash
mikacli music youtube-music search [options] <query>
```
...
Usage:
```bash
mikacli music youtube-music songid [options] <target>
```
...
Usage:
```bash
mikacli music youtube-music related [options] <target>
```
...
Usage:
```bash
mikacli music youtube-music albumid [options] <target>
```
...
Usage:
```bash
mikacli music youtube-music artistid [options] <target>
```
...
Usage:
```bash
mikacli music youtube-music playlistid [options] <target>
```
...
Usage:
```bash
mikacli music youtube-music like [options] <target>
```
...
Usage:
```bash
mikacli music youtube-music dislike [options] <target>
```
...
Usage:
```bash
mikacli music youtube-music unlike [options] <target>
```
...
Usage:
```bash
mikacli music youtube-music capabilities [options]
```
