...
- Provider: `geo`
- Category: `maps`
- Command prefix: `mikacli maps geo`
- Aliases: none
- Auth: `none`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli maps geo distance "19.0760,72.8777" "28.6139,77.2090"`
- `mikacli maps geo midpoint "19.0760,72.8777" "28.6139,77.2090"`
- `mikacli maps geo pluscode-encode 19.0760 72.8777 --length 10`
- `mikacli maps geo capabilities --json`

## Default Command

Usage:
```bash
mikacli maps geo [command]
```
...
Usage:
```bash
mikacli maps geo distance [options] <from> <to>
```
...
Usage:
```bash
mikacli maps geo midpoint [options] <from> <to>
```
...
Usage:
```bash
mikacli maps geo pluscode-encode [options] <lat> <lon>
```
...
Usage:
```bash
mikacli maps geo pluscode-decode [options] <code>
```
...
Usage:
```bash
mikacli maps geo elevation [options] <lat> <lon>
```
...
Usage:
```bash
mikacli maps geo capabilities [options]
```
