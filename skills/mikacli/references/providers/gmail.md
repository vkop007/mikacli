...
- Provider: `gmail`
- Category: `google`
- Command prefix: `mikacli google gmail`
- Aliases: none
- Auth: `oauth2`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli google gmail capabilities --json`

## Default Command

Usage:
```bash
mikacli google gmail [command]
```
...
Usage:
```bash
mikacli google gmail auth-url [options]
```
...
Usage:
```bash
mikacli google gmail login [options]
```
...
Usage:
```bash
mikacli google gmail status [options]
```
...
Usage:
```bash
mikacli google gmail me [options]
```
...
Usage:
```bash
mikacli google gmail labels [options]
```
...
Usage:
```bash
mikacli google gmail messages [options]
```
...
Usage:
```bash
mikacli google gmail message [options] <id>
```
...
Usage:
```bash
mikacli google gmail send [options] <to> [text...]
```
...
Usage:
```bash
mikacli google gmail capabilities [options]
```
