...
- Provider: `trello`
- Category: `developer`
- Command prefix: `mikacli developer trello`
- Aliases: none
- Auth: `cookies`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli developer trello login`
- `mikacli developer trello login --cookies ./trello.cookies.json`
- `mikacli developer trello me`
- `mikacli developer trello capabilities --json`

## Default Command

Usage:
```bash
mikacli developer trello [command]
```
...
Usage:
```bash
mikacli developer trello login [options]
```

Save the Trello web session for future CLI use. With no auth flags, MikaCLI opens browser login by default
...
Usage:
```bash
mikacli developer trello status [options]
```
...
Usage:
```bash
mikacli developer trello me [options]
```
...
Usage:
```bash
mikacli developer trello boards [options] [query]
```
...
Usage:
```bash
mikacli developer trello board [options] <target>
```
...
Usage:
```bash
mikacli developer trello lists [options] <board>
```
...
Usage:
```bash
mikacli developer trello cards [options] <board>
```
...
Usage:
```bash
mikacli developer trello card [options] <target>
```
...
Usage:
```bash
mikacli developer trello create-card [options] <board>
```
...
Usage:
```bash
mikacli developer trello capabilities [options]
```
