...
- Provider: `download`
- Category: `tools`
- Command prefix: `mikacli tools download`
- Aliases: none
- Auth: `none`, `cookies`
- Stability: `stable`
- Discovery: `supported`
...
Download media from most URLs supported by yt-dlp, with optional saved-session cookies from MikaCLI
...
- `mikacli tools download capabilities --json`

## Default Command

Usage:
```bash
mikacli tools download [command]
```
...
Usage:
```bash
mikacli tools download info [options] <url>
```
...
- `--platform <provider>`: Reuse a saved MikaCLI session for this provider as yt-dlp cookies
- `--account <name>`: Saved MikaCLI session account to use with --platform
...
Usage:
```bash
mikacli tools download stream [options] <url>
```
...
Usage:
```bash
mikacli tools download channel [options] <target>
```
...
Usage:
```bash
mikacli tools download video [options] <url>
```
...
Usage:
```bash
mikacli tools download audio [options] <url>
```
...
Usage:
```bash
mikacli tools download batch [options] <inputFile>
```
...
Usage:
```bash
mikacli tools download capabilities [options]
```
