...
- Provider: `notion`
- Category: `developer`
- Command prefix: `mikacli developer notion`
- Aliases: none
- Auth: `cookies`
- Stability: `partial`
- Discovery: `supported`
...
- `mikacli developer notion login`
- `mikacli developer notion login --cookies ./notion.cookies.json`
- `mikacli developer notion me`
- `mikacli developer notion capabilities --json`

## Default Command

Usage:
```bash
mikacli developer notion [command]
```
...
Usage:
```bash
mikacli developer notion login [options]
```

Save the Notion web session for future CLI use. With no auth flags, MikaCLI opens browser login by default
...
Usage:
```bash
mikacli developer notion status [options]
```
...
Usage:
```bash
mikacli developer notion me [options]
```
...
Usage:
```bash
mikacli developer notion search [options] [query]
```
...
Usage:
```bash
mikacli developer notion pages [options] [query]
```
...
Usage:
```bash
mikacli developer notion page [options] <target>
```
...
Usage:
```bash
mikacli developer notion create-page [options]
```
...
Usage:
```bash
mikacli developer notion update-page [options] <target>
```
...
Usage:
```bash
mikacli developer notion append [options] <target>
```
...
Usage:
```bash
mikacli developer notion databases [options] [query]
```
...
Usage:
```bash
mikacli developer notion database [options] <target>
```
...
Usage:
```bash
mikacli developer notion query [options] <target>
```
...
Usage:
```bash
mikacli developer notion comment [options] <target>
```
...
Usage:
```bash
mikacli developer notion capabilities [options]
```
