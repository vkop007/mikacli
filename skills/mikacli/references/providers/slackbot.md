...
- Provider: `slackbot`
- Category: `bot`
- Command prefix: `mikacli bot slackbot`
- Aliases: `slack`
- Auth: `botToken`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli bot slackbot login --token slack-bot-token-example --name alerts-bot`
- `mikacli bot slackbot me`
- `mikacli bot slackbot me --bot alerts-bot`
- `mikacli bot slackbot capabilities --json`

## Default Command

Usage:
```bash
mikacli bot slackbot [command]
```
...
Usage:
```bash
mikacli bot slackbot login [options]
```
...
Usage:
```bash
mikacli bot slackbot status [options]
```
...
Usage:
```bash
mikacli bot slackbot me [options]
```
...
Usage:
```bash
mikacli bot slackbot channels [options]
```
...
Usage:
```bash
mikacli bot slackbot history [options] <channel>
```
...
Usage:
```bash
mikacli bot slackbot send [options] <channel> <text...>
```
...
Usage:
```bash
mikacli bot slackbot send-file [options] <channel> <filePath>
```
...
Usage:
```bash
mikacli bot slackbot edit [options] <channel> <ts> <text...>
```
...
Usage:
```bash
mikacli bot slackbot delete [options] <channel> <ts>
```
...
Usage:
```bash
mikacli bot slackbot capabilities [options]
```
