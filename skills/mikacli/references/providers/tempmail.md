...
- Provider: `tempmail`
- Category: `tools`
- Command prefix: `mikacli tools tempmail`
- Aliases: none
- Auth: `session`
- Stability: `stable`
- Discovery: `supported`
...
- `mikacli tools tempmail capabilities --json`

## Default Command

Usage:
```bash
mikacli tools tempmail [command]
```
...
Usage:
```bash
mikacli tools tempmail domains [options]
```
...
Usage:
```bash
mikacli tools tempmail create [options]
```
...
- `--domain <domain>`: Optional preferred domain from `mikacli tools tempmail domains`
...
Usage:
```bash
mikacli tools tempmail login [options]
```
...
Usage:
```bash
mikacli tools tempmail status [options]
```
...
Usage:
```bash
mikacli tools tempmail me [options]
```
...
Usage:
```bash
mikacli tools tempmail inbox [options]
```
...
Usage:
```bash
mikacli tools tempmail message [options] <id>
```
...
Usage:
```bash
mikacli tools tempmail wait [options]
```
...
Usage:
```bash
mikacli tools tempmail mark-read [options] <id>
```
...
Usage:
```bash
mikacli tools tempmail delete-message [options] <id>
```
...
Usage:
```bash
mikacli tools tempmail delete-inbox [options]
```
...
Usage:
```bash
mikacli tools tempmail capabilities [options]
```
