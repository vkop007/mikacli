...
export const PLATFORM_CONFIG: Record<PlatformName, PlatformConfig> = {
  ...
  forms: {
    origin: "https://forms.googleapis.com/v1",
    homeUrl: "https://docs.google.com/forms/",
    cookieDomain: "google.com",
    authCookieNames: [],
  },
  drive: {
    origin: "https://www.googleapis.com/drive/v3",
  ...
  gmail: {
    origin: "https://gmail.googleapis.com/gmail/v1",
  ...
  sheets: {
    origin: "https://sheets.googleapis.com/v4",
    homeUrl: "https://docs.google.com/spreadsheets/",
    cookieDomain: "google.com",
    authCookieNames: [],
  },
  stocks: {
