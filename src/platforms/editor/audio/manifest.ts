...
const EXAMPLES = [
  "mikacli audio info ./song.mp3",
  "mikacli audio trim ./song.mp3 --start 00:00:10 --duration 30",
  "mikacli audio convert ./song.wav --to mp3",
  "mikacli audio compress ./song.wav --bitrate 128",
  "mikacli audio silence-detect ./song.mp3 --threshold -45dB",
  "mikacli audio loudness-report ./song.mp3",
  "mikacli audio merge ./intro.mp3 ./chapter.mp3",
  "mikacli audio fade-in ./song.mp3 --duration 3",
  "mikacli audio trim-silence ./podcast.wav --threshold -45dB",
  "mikacli audio waveform ./song.mp3 --width 1600",
  "mikacli audio spectrogram ./song.mp3 --width 1600",
  "mikacli audio normalize ./song.mp3 --loudness 16",
  "mikacli audio volume ./song.mp3 --db -3",
  "mikacli audio denoise ./voice.wav --reduction 20 --noise-floor -55",
  "mikacli audio split ./podcast.mp3 --by-silence",
  "mikacli audio mix ./voice.wav --background ./music.mp3 --bg-volume -12",
  "mikacli audio speed ./lecture.mp3 --rate 1.5",
  "mikacli audio eq ./song.mp3 --bass +3 --treble -2",
  "mikacli audio reverse ./clip.mp3",
  "mikacli audio mono ./stereo.mp3",
  "mikacli audio extract ./podcast.mp3 --start 00:10:00 --end 00:15:00",
  "mikacli audio resample ./audio.wav --rate 44100",
  "mikacli audio tag ./song.mp3 --title 'My Song' --artist 'Me'",
  "mikacli audio merge ./a.mp3 ./b.mp3 --crossfade 3",
] as const;
