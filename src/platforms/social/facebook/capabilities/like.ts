...
export const facebookLikeCapability = createAdapterActionCapability({
  id: "like",
  command: "like <target>",
  description: "Like a Facebook post by post URL, timeline URL, or numeric object ID through a browser-backed flow using the latest saved session by default",
