...
export const facebookPlatformDefinition: PlatformDefinition = {
  ...
  description: "Post, like, and comment through browser-backed flows using saved Facebook sessions or the shared AutoCLI browser profile",
  aliases: ["fb"],
  ...
  examples: [
    ...
    'autocli social facebook like "https://www.facebook.com/permalink.php?story_fbid=123&id=456"',
  ],
};
