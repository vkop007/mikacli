...
export const soundCloudPlatformDefinition: PlatformDefinition = {
  ...
  examples: [
    'autocli soundcloud search "dandelions"',
    'autocli soundcloud search "avicii" --type user',
    "autocli soundcloud track https://soundcloud.com/aditya-tanwar-714460659/ruth-b-dandelions-tiktok",
    "autocli soundcloud playlist https://soundcloud.com/lofi-hip-hop-music/sets/lofi-lofi",
    "autocli soundcloud user https://soundcloud.com/aviciiofficial",
    'autocli soundcloud related "dandelions" --limit 5',
    'autocli soundcloud download "dandelions" --output-dir ./downloads',
  ],
};
