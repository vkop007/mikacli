...
export function createJiraLoginCapability(adapter: JiraAdapter) {
  return createAdapterActionCapability({
    ...
    options: [
      ...
      { flags: "--site <url>", description: "Jira site URL, like https://your-workspace.atlassian.net" },
      { flags: "--account <name>", description: "Optional saved alias instead of the detected Jira account" },
